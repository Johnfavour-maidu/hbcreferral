              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                {socials.map((social) => (
                  <Link
                    ...
                    className={`group inline-flex items-center gap-2.5 ${social.bg} text-white rounded-[22px] px-8 h-[50px] text-[15px] font-semibold transition-all duration-300 hover:-translate-y-1 hover:scale-[1.03] ${social.hoverShadow}`}
                  >
